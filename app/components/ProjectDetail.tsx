            ...
            <div className="mb-12 grid gap-6 border-b border-neutral-200 pb-12 md:grid-cols-3">
              ...
              <div>
                ...
                <p
                  ...
                  style={{ fontFamily: "var(--font-display)" }}
                >
                  {locale === "en" ? "Choreographic creation" : "Création chorégraphique"}
                </p>
              </div>
              <div>
                <h3
              ...
              <div className="grid gap-y-4 gap-x-24 md:grid-cols-2">
                <div className="flex justify-between border-b border-neutral-100 pb-3">
                  <span
                    ...
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {locale === "en" ? "Choreography" : "Chorégraphie"}
                  </span>
                  <span
                ...
                <div className="flex justify-between border-b border-neutral-100 pb-3">
                  <span
                    ...
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {locale === "en" ? "Performance" : "Interprétation"}
                  </span>
                  <span
                    className="text-sm font-light"
                    style={{ fontFamily: "var(--font-body)" }}
                ...
                <div className="flex justify-between border-b border-neutral-100 pb-3">
                  <span
                    ...
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {locale === "en" ? "Music" : "Musique"}
                  </span>
                  <span
                    className="text-sm font-light"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {locale === "en" ? "Original composition" : "Composition originale"}
                  </span>
                </div>
              </div>
            </div>
